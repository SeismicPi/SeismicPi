...
CPP_SRCS += \
../Sources/Console/Command_Parser.cpp \
../Sources/Console/Console.cpp 

OBJS += \
./Sources/Console/Command_Parser.o \
./Sources/Console/Console.o 

CPP_DEPS += \
./Sources/Console/Command_Parser.d \
./Sources/Console/Console.d 


# Each subdirectory must supply rules for building sources it contributes
Sources/Console/%.o: ../Sources/Console/%.cpp
	@echo 'Building file: $<'
